...
/*   Updated: 2025/09/22 19:14:52 by rabu-shr         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int AForm::getGradeToSign() const//Minimum grade required to sign the AForm.
// Lower number = higher rank.
{
    return gradeToSign;
}

int AForm::getGradeToExecute() const // Minimum grade required to execute the AForm.
{
